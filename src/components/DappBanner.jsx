...
export default function DappBanner() {
  return (
    <div className="relative lg:col-span-2 h-full">
      ...
      <div className="relative overflow-hidden bg-white border border-gray-200 rounded-2xl h-full">
        <div className="p-6 md:p-8">
          ...
          <div className="flex gap-2 m-2">
            <p className=" text-md font-base  font-pj text-green-700">DEX</p>
            <p className=" text-md font-base  font-pj text-orange-700">DeFi</p>
            <p className=" text-md font-base  font-pj text-blue-700">Bridge</p>
          </div>
